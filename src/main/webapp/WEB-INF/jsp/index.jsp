...
<head>
    ...
    <style>
		...
		body  {
		    background-image: url("images/zia-background.jpg");
...
<body>
	...
	<div role="navigation">
		<div class="navbar navbar-inverse">
			<a href="/" class="navbar-brand"><img src="images/minaret-small.jpg" alt="" /></a>
	...
	<c:choose>
		<c:when test="${mode == 'MODE_HOME'}">
			<div class="container" id="homeDiv">
				...
				<h3 class="display-3 thick">Welcome to Zakaria Islamic Academy</h3>
				</div>
			</div>
		</c:when>
